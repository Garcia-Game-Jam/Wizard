...
Canonical docs for visual and UX conventions. Linked from [AGENTS.md](../../AGENTS.md).
...
Add new aesthetic guides here (typography, motion, iconography, etc.) and link them from `AGENTS.md`.
