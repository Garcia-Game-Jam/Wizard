...
const LightSpell := preload("res://scenes/spells/light/light.tres")
const LightBallSpell := preload("res://scenes/spells/light_ball/light_ball.tres")
const TargetSpell := preload("res://scenes/spells/target/target.tres")
const PullSpell := preload("res://scenes/spells/pull/pull.tres")
const FollowSpell := preload("res://scenes/spells/follow/follow.tres")
const StopSpell := preload("res://scenes/spells/stop/stop.tres")
const DispellSpell := preload("res://scenes/spells/dispell/dispell.tres")
const CloneSpell := preload("res://scenes/spells/clone/clone.tres")
